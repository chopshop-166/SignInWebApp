...
def upgrade():
    ...
    with op.batch_alter_table("account_types", schema=None) as batch_op:
        batch_op.add_column(
            sa.Column("receives_funds", sa.Boolean(), nullable=False, server_default="false")
        )
    ...
    with op.batch_alter_table("events", schema=None) as batch_op:
        batch_op.add_column(
            sa.Column("registration_open", sa.Boolean(), nullable=True, server_default="false")
        )
        batch_op.add_column(sa.Column("funds", sa.Integer(), nullable=False, server_default="0"))
        batch_op.add_column(sa.Column("cost", sa.Integer(), nullable=False, server_default="0"))
        batch_op.add_column(sa.Column("overhead", sa.Float(), nullable=False, server_default="0.5"))
