...
def upgrade():
    ...
    with op.batch_alter_table("account_types", schema=None) as batch_op:
        batch_op.add_column(sa.Column("receives_funds", sa.Boolean(), nullable=False))
    ...
    with op.batch_alter_table("events", schema=None) as batch_op:
        batch_op.add_column(sa.Column("registration_open", sa.Boolean(), nullable=True))
        batch_op.add_column(sa.Column("funds", sa.Integer(), nullable=False))
        batch_op.add_column(sa.Column("cost", sa.Integer(), nullable=False))
        batch_op.add_column(sa.Column("overhead", sa.Float(), nullable=False))
